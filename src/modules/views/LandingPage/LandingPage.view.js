...
import { Grid, Box, Typography, IconButton, Badge, Button } from "@mui/material";
...
import globalsVariable from "../../global";
...
export default function LandingPage(props) {
    ...
    const authedUser = globalsVariable.auth.user
    ...
    const images = [
        { image: '/images/landing-image/landing1.jpg' },
        { image: '/images/landing-image/landing3.jpg' },
    ]
                        ...
                        <Grid container spacing={2} justifyContent={'flex-end'}>
                            <ul className={classes.listItems}>
                                {itemsLinks.map(({ text, icon, url, badge }, index) => (
                                    text === 'Log in' ? authedUser?.user_role && authedUser.user_role === 'Client' ?
                                        <Button
                                            variant='text'
                                            onClick={(e) => authContext.handleAuth(false)}
                                            style={{ color: '#fff' }}
                                        >
                                            Log out
                                        </Button>
